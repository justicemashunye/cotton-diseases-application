                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        @foreach($diseases as $disease)
                            <tr>
                                <td>{{ $disease->diseasedetail->name}}</td>
                                <td>{{ $disease->stage->name }}</td>
                                <td>{{ $disease->location->name }}</td>
                                <td>{{ $disease->shape->description}}</td>
                                <td>{{ $disease->color->name }}</td>
                                <td>{{ $disease->colorstate->description }}</td>
